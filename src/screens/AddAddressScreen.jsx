...
import { TextSemiBold } from '../components/IconSize/Sizes';
...
const AddAddresScreen = () => {
  ...
  const GoogleMapsKey = 'AIzaSyARhFVFYkqqbvJ1moa2_73JMEa8Z5LeVaM';

  const AddAddressHandle = () => {
    Alert.alert('Address', 'Address Added', [
      ...
      <ScrollView>
        <View style={{ flex: 1 }}>
          ...
          <View style={styles.Maincontainer}>
            <View style={{ gap: RF(5) }}>
              <Text
                style={[TextSemiBold, { color: SimpleText, fontSize: RF(16) }]}
              >
                Personal Details
              </Text>
