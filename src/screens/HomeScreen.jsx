...
import { Avacado, Brocli, CatIconApple, CatIconBabyCare, CatIconDrink, CatIconEdible, CatIconGrocery, CatIconHouseHold, CatIconvegitable, FilterIcon, Grapes, HomeBackGround, MinusIcon, Peach, Pineapple, PlusIcon, Pomgrante, RightIcon, SearchIcon } from '../assets/Index';
import { LightGrey, Link, MidGrey, Primary, Secondary, SimpleText, White } from '../styles/colors/colorsCode';
...
const ProductsImages = [
    ...
    { id: '2', source: Avacado, color: '#FCFFD9', name: "Avacado", price: '$7.00', Size: '2.0 lbs' },
    { id: '3', source: Pineapple, color: '#FFE6C2', name: "Pineapple", price: '$9.90', Size: '1.50 lbs' },
    { id: '4', source: Grapes, color: '#FEE1ED', name: "Black Grapes", price: '$7.05', Size: '5.0 lbs' },
    { id: '5', source: Pomgrante, color: '#FFE3E2', name: " Pomegrante", price: '$2.09', Size: '1.50 lbs' },
