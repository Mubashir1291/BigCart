...
const OnBoard1 = () => {
  ...
  return (
    <SafeAreaView style={styles.container}>
      ...
      >
        {/* Slide 1 */}
        <ImageBackground source={Slide1} style={styles.slide} resizeMode="cover">
        ...
        {/* Slide 2 */}
        <ImageBackground source={Slide2} style={styles.slide} resizeMode="cover">
          <View style={styles.TextContainer}>
        ...
        {/* Slide 3 */}
        <ImageBackground source={Slide3} style={styles.slide} resizeMode="cover">
          <View style={styles.TextContainer}>
            <Text style={styles.Heading1}>Buy Quality</Text>
        ...
        {/* Slide 4 */}
        <ImageBackground source={Slide4} style={styles.slide} resizeMode="cover">
          <View style={styles.TextContainer}>
            <Text style={styles.Heading1}>Welcome To</Text>
            <Image source={AppLogo} style={styles.BigCartLogo} />
          </View>
        </ImageBackground>
      </Swiper>
